          ...
          <div className="progress-steps-container">
            ...
            <div className="progress-steps">
              {processingSteps.map((step, index) => (
                <div 
                  key={index} 
                  className={`progress-step ${index <= processingStep ? 'active' : ''}`}
                >
          ...
          <div className="agent-progress-container">
            ...
            <div className="agent-status">
              <p className="agent-name">
                {agentStatus.currentAgent === 'psychometric_analysis' && '🧠 Psychometric Analysis'}
                {agentStatus.currentAgent === 'check_missing' && '🔍 Checking Analysis Completeness'}
                {agentStatus.currentAgent === 'judge_analysis' && '⚖️ Evaluating Analysis Quality'}
                {agentStatus.currentAgent === 'correlated_analysis' && '🔄 Analyzing Correlated Domains'}
                {agentStatus.currentAgent === 'check_bias' && '⚠️ Checking Response Bias'}
                {agentStatus.currentAgent === 'item_analysis' && '📊 Item-Level Analysis'}
                {agentStatus.currentAgent === 'complete' && '✅ Analysis Complete'}
                {agentStatus.currentAgent === 'error' && '❌ Error'}
                {!agentStatus.currentAgent && 'Starting...'}
              </p>
